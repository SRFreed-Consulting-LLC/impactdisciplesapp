...
@Component({
  selector: 'app-lesson-previewer',
  templateUrl: './lesson-previewer.component.html',
  styleUrls: ['./lesson-previewer.component.css']
})
export class LessonPreviewerComponent implements OnInit {
